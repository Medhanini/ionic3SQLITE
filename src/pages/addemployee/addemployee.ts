...
result="";
  ...
  .then((res) => {                               //add res
    ...
    this.toast.show('Done data inserted01!','4000','center').subscribe(
      toast => {
        this.navCtrl.push(HomePage);
          ...
          .catch(e => {
            this.toast.show('Done data inserted 1!','4000','center').subscribe(
              toast => {
                console.log(e);
              }
            );
    ...
    this.toast.show('Done data inserted 2!','4000','center').subscribe(
      toast => {
        console.log(e);
      }
    );
